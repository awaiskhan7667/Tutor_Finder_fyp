...
export default function Home() {
  ...
  useEffect(() => {
    ...
    getAllTutors()
      .then((res) => setTutors(res.data.tutors.slice(0, 6)))
      .catch(() => {});
  }, []);
  ...
  return (
    <div className="overflow-x-hidden bg-white">
        ...
        <div className={`relative max-w-5xl mx-auto px-6 text-center transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"}`}>
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight tracking-tight">
            ...
            <span className="relative inline-block">
              ...
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 to-pink-400 rounded-full animate-glow" />
            </span>
          </h1>

          <p className="text-blue-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            Connect with verified expert tutors for online & in-person sessions. Any subject, any level, anywhere in Pakistan.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <div
              ...
              className={`text-center group transition-all duration-700 ${inView(statsInView, i)}`}
            >
      ...
      {/* ══ FEATURED TUTORS ══ */}
      <section ref={tutorsRef} className="bg-white py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-blue-600 font-bold tracking-widest text-sm mb-3 uppercase">Top Educators</p>
            <h2 className="text-4xl md:text-5xl font-black text-gray-800 mb-4">Featured Tutors</h2>
              ...
              {tutors.map((tutor, i) => (
                ...
                >
                  ...
                  <div className="px-6 pb-6 -mt-10 relative">
                    <div className="w-20 h-20 bg-white border-4 border-white rounded-2xl flex items-center justify-center text-3xl font-black text-blue-600 shadow-xl mb-4 group-hover:scale-110 transition-transform duration-300">
                  ...
                  {/* Hover overlay */}
                  <div className="absolute inset-0 bg-blue-600/0 group-hover:bg-blue-600/5 transition-all duration-300 rounded-3xl flex items-center justify-center">
          ...
          <div className="text-center mt-14">
            <button
              ...
              className="group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-black px-12 py-5 rounded-2xl transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-blue-500/30 flex items-center gap-3 mx-auto"
            >
              View All Tutors
      ...
      <section ref={ctaRef} className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-900 animate-gradient bg-300%" />
        <div className="absolute inset-0 opacity-10"
        ...
        <div className={`relative max-w-3xl mx-auto px-6 text-center transition-all duration-1000 ${ctaInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <p className="text-blue-100 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Join TutorFinder and start earning by teaching students online & in-person across Pakistan.
          </p>
...
// helper — only animate when section is in view
function inView(isInView, i) {
  return isInView
